...
"""
Test cases for REQ-SYNC-001: backup_logs completion sentinel gate.
...
Log messages verified (strategies.c reboot_setup()):
  - Present : "bacukup_logs sentinel detected. Proceeding."
  - Absent  : "backup_logs not done (%s absent); aborting upload"
"""
